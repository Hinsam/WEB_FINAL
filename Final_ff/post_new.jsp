...
<body>
    ...
    <form action="post_new_send.jsp" method="post" >
        <table>
            ...
            <tr>
                <td>ID</td>
                <td><input type="text" name="UserId" id="UserId" value="<%= (String)session.getAttribute("User") %>" readonly></td>
            </tr>
            <tr>
                <td>설명</td>
                <td><textarea rows="10" cols="20" id="ItemDescription" name="ItemDescription"></textarea></td>
            </tr>
            <tr>
                <td>기한</td>
